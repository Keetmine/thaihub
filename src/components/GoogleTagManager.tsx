...
/**
 * СЕЙЧАС НЕ ИСПОЛЬЗУЕТСЯ (2026-09-16): контейнер GTM-MS7GF6WQ на проде
 * пустой — ноль сработавших тегов, в dataLayer только служебные
 * события. Скрипт грузился и не делал ничего, поэтому вызов убран из
 * CookieConsent. Код цел: положите что-нибудь в контейнер — и вернуть
 * его будет делом двух строк (проп `gtmId` в CookieConsent и рендер
 * рядом с GoogleAnalytics). GA4 идёт мимо контейнера, напрямую через
 * gtag.js, так что дублирования просмотров не было и не будет.
 *
