...
//
// ВСЕГДА ставится САМЫМ НИЖНИМ блоком страницы (решение владельца,
// 2026-08-30) — после отзывов, комментариев и рекомендаций. Новые
// страницы с источниками должны соблюдать это же место.
