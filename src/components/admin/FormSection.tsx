 ...
 *  фокуса у полей внутри. Палитра — тёплые сине-красные оттенки вокруг
 *  фиолетового акцента админки (правка владельца 2026-09-26: «цвета
 *  слишком разные; фиолетовый наш основной, и от него расходится»). */
export type SectionTone = "violet" | "purple" | "magenta" | "rose" | "red" | "indigo";
