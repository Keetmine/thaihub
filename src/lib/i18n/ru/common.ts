...
export const common: Dict["common"] = {
  ...
  deletedAccount: "Удалённый аккаунт",
    year: "год",
    language: "Язык",
  /** Кнопки листания горизонтальных лент (ScrollRow). Общие, а не в
   *  словаре раздела: одна и та же лента стоит и в каталоге, и на
   *  странице артиста. */
  scrollPrev: "Пролистать влево",
  scrollNext: "Пролистать вправо",
};
