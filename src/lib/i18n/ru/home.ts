...
export const home: Dict["home"] = {
    ...
    startFriendsHint: "Видно, кто что смотрит и на какие события идёт",
    startCommunities: "Загляните в сообщества",
    startCommunitiesHint: "Там договариваются о встречах и обсуждают серии",
    startDramas: "Отметьте, что смотрите",
    startDramasHint: "Счётчик серий, оценки и статистика — из ваших отметок",
