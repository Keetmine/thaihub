...
export const catalog: Dict["catalog"] = {
    ...
    showingFirst: (n: number) =>
        `Показаны первые ${n} результатов — уточните запрос, чтобы увидеть более точные совпадения.`,
    ...
    dramas: {
        ...
        title: "Сериалы",
        searchIsGlobal: "Поиск идёт по всему каталогу, независимо от вкладок.",
    ...
    artists: {
        ...
        favorites: "Избранное",
        hint:
            "Здесь показаны избранные и актёры с событиями в афише — а всего в каталоге тысячи актёров. Если кого-то нет в списке, наберите имя в поиске справа.",
    ...
    location: {
        ...
        metaDescription: (name: string) =>
            `${name}: место съёмок тайских BL-сериалов — как добраться и что здесь снимали.`,
        back: "← Все локации",
