...
export const communities: Dict["communities"] = {
    ...
    heading: "Сообщества",
    eyebrow: "Вместе",
    intro: "Место, где находят своих — тех, кто любит то же самое.",
    ...
    cover: {
        title: "Обложка",
        hint: "Квадратная картинка — перед сохранением её можно подвинуть и приблизить.",
        ...
        wait: "Обложка ещё загружается — секунду",
    },
