...
export const notifications: Dict["notifications"] = {
  ...
  tripCountdown: [
    ...
    "6 дней. Где-то уже заправляют ваш самолёт. Ну, почти ваш 🛩️",
    "Жееееесть, поездка уже через неделю 😱",
    "8 дней. Голова уже в Бангкоке, дома осталось только тело 🙃",
    ...
    "24 дня. Это два сериала по 12 серий, если по серии в день. Успеете оба 📺",
