export const events = {
  ...
  going: {
    promptPast:
      "Were you there? Tick the dates — they will count towards your stats:",
    promptFuture:
      "Going? Tick your dates — they go into your calendar and trip plan:",
    ...
    premium: "Going marks are part of the subscription",
  },
  ...
  tickets: {
    ...
    onlineBooking: {
      ...
      cancel: "Cancel",
      reminderHint:
        "We'll remind you an hour before it opens — in the bell and in Telegram.",
  ...
  search: {
    ...
    missingSomething:
      "Didn't find the series or the actor you were after? Tell us — we'll add it.",
