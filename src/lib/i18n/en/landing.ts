export const landing = {
    ...
    aboutTitle: "Made by fans, for fans",
    aboutStory:
      "MyBLHub grew out of personal spreadsheets and notes: when the presale starts, where to fly, what to watch next. At some point the spreadsheets stopped coping — so we put it all into one service: the feed, the catalogue and a trip planner.",
    aboutNoAds:
      "No algorithms and no ads here — just events, the artists you love and people on the same wavelength. Something missing?",
