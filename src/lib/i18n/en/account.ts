...
export const account = {
  ...
  settings: {
    ...
    exportHint: "Take your data as a spreadsheet — the files open in Excel and Google Sheets. One file per section.",
    exportDramas: "Series",
    exportEvents: "Events",
    exportTrips: "Trips",
    exportTripItems: "Trip entries",
    exportArtists: "Artists",
    exportPlaces: "Places",
    tourTitle: "Site tour",
