...
export const legal = {
    ...
    about: {
      metaTitle: "About",
      metaDescription:
        "MyBLHub — a tracker of concerts and fan events for Thai BL actors: the event feed, artist and series profiles, favourites and watch statuses.",
    },
    terms: {
    ...
    help: {
      ...
      whatText:
        "MyBLHub is a tracker of concerts and fan events for Thai BL actors: a schedule of events, artist and series profiles, favourites and watch statuses.",
