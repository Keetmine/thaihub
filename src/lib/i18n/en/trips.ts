...
export const trips = {
    ...
    places: {
        ...
        ownMark: "your own place",
        searchHint: "Start typing a name — or a series title, if the place is from a shoot",
        nothingFound: "Nothing found. Add your own place from a Google Maps link.",
        noteLabel: "Note",
        notePlaceholder: "What for: coffee after the shoot, a photo by the sign…",
        noteAdd: "+ Note",
        attachTitle: "Or attach a list you already have",
    ...
    bookings: {
        ...
        whoFlies: "Who's flying",
        whoStays: "Who's staying",
        whoHint: "One flight for everyone is one entry. Each of you can attach your own ticket.",
        you: "you",
        flyingLabel: (names: string) => `Flying: ${names}`,
        stayingLabel: (names: string) => `Staying: ${names}`,
        joinFlight: "I'm on this flight too",
        leaveFlight: "I'm not on this flight",
        joinStay: "I'm staying here too",
        leaveStay: "I'm not staying here",
        myTicket: "My ticket ↗",
        myBooking: "My booking ↗",
        attachMyTicket: "+ My ticket",
        attachMyBooking: "+ My booking",
        attachTicketTitle: "Your ticket",
        attachBookingTitle: "Your confirmation",
        attachHint: "Only you and the trip participants can see the file.",
        joinedExisting: (name: string) => `Flight ${name} was already in the trip — you've been added to it.`,
    },
