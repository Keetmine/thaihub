...
export const trips = {
    ...
    expenses: {
        ...
        budget: "Budget",
        budgetHint: "One per currency: we don't store exchange rates, so baht and roubles are never added up. An empty field removes the budget.",
        budgetPlaceholder: "50000, say",
        ofBudget: (budget: string) => `of ${budget}`,
        overBudget: (over: string) => `${over} over`,
        ...
        fieldDate: "When",
        fieldBooking: "From the trip's bookings",
        noBooking: "Don't link",
        fieldNote: "Note",
        currency: {
            THB: "Baht ฿",
            RUB: "Roubles ₽",
