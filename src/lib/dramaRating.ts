 ...
 * как есть. Сотня (решение владельца 2026-09-07, было 20) означает: их
 * тысячи отзывов перевесить непросто, и наша оценка становится заметной
 * не с первого голоса, а когда за сериалом стоит уже сколько-то людей.
