...
/** Пропорции обложки профиля — рамка кадрирования в настройках и
 *  карточка на самой странице считают их одинаково (иначе человек
 *  кадрирует одно, а видит другое). Широкая полоса, а не банер во весь
 *  экран: над колонкой шириной 17.5rem она читается как шапка, а не как
 *  главная картинка страницы. */
export const PROFILE_COVER_RATIO_W = 16;
export const PROFILE_COVER_RATIO_H = 5;
