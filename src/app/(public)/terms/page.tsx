      ...
      <div className="surface p-4 d-flex flex-column gap-4">
        ...
        <section>
          ...
          <ul className="text-secondary mb-0 d-flex flex-column gap-2">
            ...
            <li>
              Оплата проходит внутри Telegram (Telegram Stars). Мы не получаем и не
              храним данные банковских карт.
            </li>
            <li>
        ...
        <section>
          ...
          <p className="mb-0 text-secondary">
            Если сервис не работает так, как обещано, напишите нам в течение 14 дней
            после оплаты — вернём звёзды полностью. Возврат оформляется средствами
            Telegram на тот же аккаунт, с которого была оплата; подписка при этом
            прекращается.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mb-0 text-secondary">
            ...
            указанием авторства, напишите нам — поправим.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mb-0 text-secondary">
            Мы храним то, что нужно для работы сервиса: аккаунт (почта или Telegram),
            избранное, отметки «иду», поездки и заметки. Настройки приватности в
            профиле управляют тем, что видят другие пользователи. Данные не
