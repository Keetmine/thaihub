...
внутри фактов тоже приглушены и **без подчёркивания** (правка владельца
2026-09-07): строка фактов читается как текст, а не как список ссылок.
Теги и чипы жанров сохраняют своё оформление.
