...
у MDL их десятки, и чипы раздували карточку. Строка одна, со свёрткой
«показать все» (`TagRowFold` — меряет фактическую высоту, как капсулы
CastGrid). Жанры остались чипами.
