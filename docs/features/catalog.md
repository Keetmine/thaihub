...
«Мой список» устроен по-прежнему: вкладки статусов, полный список
отмеченного, сортировка в JS, без фильтров и страниц. Поиск в нём идёт
по ВСЕМУ каталогу (Ж5) — человек ищет сериал, чтобы его отметить,
значит в списке того ещё нет.
...
верны при любой ширине и не требуют пересчёта на ресайз). Линия нужна
затем, чтобы было видно, СКОЛЬКО ещё осталось: растушёванный край и
кнопки этого не говорят.
