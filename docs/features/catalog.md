...
«3/13», по наведению на карточку чип разворачивается в «− 3/13 +» —
кнопки в покое не занимают места вовсе (`display: none`, а не
прозрачность), иначе чип был бы втрое шире ради невидимого. Без ховера
(палец) кнопки показываются всегда.
