...
тысячи». Теперь оценка MDL входит как `MDL_VOTES` (20) голосов, наши —
как есть: один наш голос почти не двигает итог (7.5 → 7.6), двадцать
весят наравне с MDL, дальше перевешивают. Это единственная ручка, и
крутится она в `dramaRating.ts`.
