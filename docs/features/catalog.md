...
постере, без рамки: надзаголовок «10 серия через» с пульсирующей
точкой, под ним крупный акцентный остаток («2 дня», «Завтра»,
«Сегодня»). При «Сегодня» и «Завтра» слова «через» нет — «10 серия
...
нужен. Надзаголовок приглушённый, акцент оставлен только сроку и точке;
точка пульсирует, потому что это единственное на странице, что меняется
само по себе — при `prefers-reduced-motion` она просто стоит. CSS —
