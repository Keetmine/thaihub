...
Факты → «Из ваших друзей смотрели» → актёрский состав → «Смотреть по
порядку» (бывшие связанные сериалы) → события (фан-миты, премьеры) →
...
- Открыта гостю и **индексируема**: есть в `STATIC_PATHS` карты сайта
  ...
  «N зрителей». Ссылка на топ стоит вкладкой «Народный топ» в ряду
