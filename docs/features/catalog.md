...
Блок «Понравился этот — посмотрите ещё» на странице сериала
...
Карточки те же, что у сериалов на странице артиста: постер 2:3 в
`poster-row`, название, кнопка статуса просмотра; вторая строка — причина
(«N общих актёров») либо год. Сиквелы и прочий
