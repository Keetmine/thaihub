...
В карточке — **состав пары «A × B»** (правка владельца 2026-09-10:
«выводим как раньше, актёр × актёр»). Ссылка и фото ведут к ПАРТНЁРУ:
карточка стоит на странице человека, и «открыть» тут значит «открыть
второго». Одного имени партнёра мало — по нему не видно, чья это пара и
в каком она порядке. В чипах события и «чей маскот» — то же «A × B».

Порядок имён в подписи — **из самого пейринга** и нигде не
