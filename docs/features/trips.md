...
Вкладка **«Списки»** (между «Афишей» и «Что посетить»; видна тем, кто
...
не в состоянии компонента: ссылкой на покупки удобно кинуть попутчице, а
кнопка добавления стоит в ряду над вкладками и должна знать, куда
добавлять — на чемодане она так и зовётся «+ Вещь». Сегменты нарисованы
кнопками внутри вкладки, а не тремя вкладками верхнего ряда: там уже
четыре, и «Чемодан» рядом с «Афишей» читался бы как равный ей раздел. У
чемодана и покупок в сегменте стоит «собрано/всего».
