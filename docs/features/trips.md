...
- **вещь и покупку** — кнопкой «+ Добавить» в их же вкладке (та же
  модалка, заголовок и подсказка — по списку). Быстрый ввод строкой
  здесь был и убран по просьбе владельца: одна понятная кнопка вместо
  поля с неявным Enter.

Сам список идёт во всю ширину колонки: у чемодана строки короткие, и
узкая колонка растягивала его в простыню.
