...
заголовок — раскрывашка, шеврон у правого края (агентства и теги
свёрнуты по умолчанию, группа с активным значением открыта всегда;
состояние клиентское — серверный `details` захлопывался при каждой
смене фильтра); под заголовком — короткая подсказка (`hint` из
