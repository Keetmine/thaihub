...
- **Генерация — в одном месте**: расширение Prisma-клиента
  ...
  с нумерацией при совпадении; Trip/PlaceList — название + код;
  Community — чистое название, а код только если оно уже занято
  (правка владельца 2026-09-09, см. [communities.md](communities.md)). Слаг
...
- **Освободившийся слаг после слияния дублей**: выживший забирает
  «чистый» вариант вместо `-2`. См. «Слаг после слияния» в
