...
`Review.isPrivate` — чекбокс «Виден только мне» в форме отзыва
(создание и редактирование, `ReviewsAndComments.tsx` →
...
- **Свой приватный** автор видит в общем списке с бейджем «виден
  только вам» (`t.reviews.privateBadge`).
