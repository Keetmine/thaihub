...
Таблица та же, что в каталоге (`DramasTable`), но в СВОЁМ профиле
колонка серий — рабочий счётчик «− 3/10 +» (`EpisodeProgress
variant="inline"`, правка владельца 2026-09-06): отмечать серии прямо
отсюда быстрее, чем идти в каталог или на страницу сериала. В чужом
профиле там просто «3/10» — чужой прогресс не наш.
...
всю ширину колонки занимала полэкрана и обещала не тот кадр.
