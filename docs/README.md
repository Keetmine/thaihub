...
- Features:
  ...
  - [facts-review.md](features/facts-review.md) — очередь фактов артистов с внешних источников: разбор руками в /admin/facts — таблица «до / после объединения / перевод», новые с «+»
